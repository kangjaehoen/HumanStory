...
<body>
	...
	<nav
		class="fixed top-0 z-50 w-full bg-white b dark:bg-gray-800 dark:border-gray-700">
			...
			<div class="flex items-center justify-between">
				<div class="flex items-center justify-start rtl:justify-end">
                 ...
                 <path clip-rule="evenodd" fill-rule="evenodd"
					...
					<a href="https://flowbite.com" class="flex ms-2 md:me-0"> <img
						src="https://flowbite.com/docs/images/logo.svg" class="h-5 me-3"
						alt="HS Logo" /> <img src="./resources/img/hs2.logo.png"
						class="h-16 me-2" alt="HS Logo" /> <!-- <span
						class="self-center text-xl font-semibold sm:text-1xl whitespace-nowrap dark:text-white">HUMAN
							STORY</span> -->
					</a>
				</div>
						...
						<div>
							<button type="button"
								...
								<span class="sr-only">Open user menu</span> <img
									...
									src="./resources/img/profile.png" alt="user photo">
								<p class="text-1xl text-white dark:text-white p-1 mr-2"
									role="none">강재헌</p>

							</button>
						</div>
						<div
							class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-whitetext-white"
							id="dropdown-user">
							<div class="px-4 py-3" role="none">
								<p
									class="text-sm text-black hover:text-gray-900 dark:text-white"
									role="none">아이유는</p>
								<p
									class="text-sm font-medium text-black hover:text-gray-900 truncate dark:text-gray-300"
									role="none">재헌이를 안좋아해</p>
							</div>
							<ul class="py-1" role="none">
								...
								<li><a href="#"
									class="block px-3 py-1 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-whitetext-white dark:hover:text-white"
									role="menuitem">Document</a></li>
								<li>
									<form action="/customLogout" method='post'>
										<input type="hidden" name="${_csrf.parameterName}"
											value="${_csrf.token}" /> <a href="../customLogin"
											class="block px-3 py-1 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-whitetext-white dark:hover:text-white"
	...
	<aside id="logo-sidebar"
		...
		<div class="h-full px-4 pb-4 overflow-y-auto bg-gray-800 w-67 mt-4">
			...
			<p
				class="text-xl text-white dark:text-white text-center font-bold mt-2"
				role="none">강재헌</p>
       ...
       <path
			...
			<ul class="space-y-4 font-midium">
				<li><a href="#"
					class="flex items-center p-1 text-white hover:text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group mt-5">
						<svg
							class="w-6 h-6 text-gray-100 transition duration-75 dark:text-gray-400 group-hover:text-white hover:text-gray-900 dark:group-hover:text-gray-100"
                   ...
                   <path fill-rule="evenodd"
								...
								clip-rule="evenodd" />
               </svg> <span class="ms-3 mt-1.5">Home</span>
				</a></li>
				...
				<li><a href="#"
					class="flex items-center p-1 text-white hover:text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
						<svg
							class="w-7 h-7 text-gray-100 transition duration-75 dark:text-gray-400 group-hover:text-white hover:text-gray-900 dark:group-hover:text-gray-100"
							aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24"
							height="24" fill="currentColor" viewBox="0 0 24 24">
                  <path
								d="M17.133 12.632v-1.8a5.406 5.406 0 0 0-4.154-5.262.955.955 0 0 0 .021-.106V3.1a1 1 0 0 0-2 0v2.364a.955.955 0 0 0 .021.106 5.406 5.406 0 0 0-4.154 5.262v1.8C6.867 15.018 5 15.614 5 16.807 5 17.4 5 18 5.538 18h12.924C19 18 19 17.4 19 16.807c0-1.193-1.867-1.789-1.867-4.175ZM6 6a1 1 0 0 1-.707-.293l-1-1a1 1 0 0 1 1.414-1.414l1 1A1 1 0 0 1 6 6Zm-2 4H3a1 1 0 0 1 0-2h1a1 1 0 1 1 0 2Zm14-4a1 1 0 0 1-.707-1.707l1-1a1 1 0 1 1 1.414 1.414l-1 1A1 1 0 0 1 18 6Zm3 4h-1a1 1 0 1 1 0-2h1a1 1 0 1 1 0 2ZM8.823 19a3.453 3.453 0 0 0 6.354 0H8.823Z" />
               </svg> <span class="flex-1 ms-2 whitespace-nowrap">Alert</span>
                ...
                <path fill-rule="evenodd"
								...
								clip-rule="evenodd" />
              </svg> <span class="flex-1 ms-2.5 whitespace-nowrap">ADD
							Leaves</span> <span
            ...
            <li>
					...
					<li><a href="#"
						class="flex items-center p-2 text-white hover:text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
							<button @click="open = !open"
								...
								<svg
									class="w-5 h-5 text-white transition duration-75 dark:text-white group-hover:text-gray-900 hover:text-gray-900 dark:group-hover:text-gray-100"
									aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                      ...
                      <path
								...
								<span class="hover:text-gray-900 ml-3 mr-8">Dashboard</span> <span>
									<svg class="h-4 w-4 ml-6" viewBox="0 0 14 24" fill="none"
										xmlns="http://www.w3.org/2000/svg">
                      <path x-show="! open" d="M9 5L16 12L9 19"
                      ...
                      <path x-show="open" d="M19 9L12 16L5 9"
						...
						<div x-show="open" class="bg-gray-800 rounded-lg">
							<a
								class="py-2 px-16 block text-sm text-white hover:bg-blue-500 hover:text-gray-900 hover:bg-white rounded-lg text-center"
								href="#">Calendar</a> <a
								class="py-2 px-16 block text-sm text-white hover:bg-blue-500 hover:text-gray-900 hover:bg-white rounded-lg text-center"
								href="#">PTO List</a>
						</div></li>
              ...
              </svg> <span class="flex-1 ms-2 whitespace-nowrap">Document</span>
				</a></li>
					...
					<li><a href="#"
						class="flex items-center p-1 text-white hover:text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
							<button @click="open = !open"
								class="flex justify-between items-center pl- text-gra cursor-pointer hover:bg-gray-100 hover:text-gray-700 focus:outline-none">
								<svg
									class="w-8 h-8 text-gray-100 transition duration-75 dark:text-gray-400 group-hover:text-white hover:text-gray-900 dark:group-hover:text-gray-100"
									aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
									width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                        <path fill-rule="evenodd"
								...
								<span class="hover:text-gray-900 ml-1 mr-8">Users
									Settings</span> <span> <svg class="h-4 w-4 ml-4"
                      ...
                      <path x-show="open" d="M19 9L12 16L5 9"
						...
						<div x-show="open" class="bg-gray-800 rounded-lg">
							<a
								class="py-2 px-16 block text-sm text-white hover:bg-blue-500 hover:text-gray-900 hover:bg-white rounded-lg text-center"
								href="../emp/list">Employees</a> <a
								class="py-2 px-16 block text-sm text-white hover:bg-blue-500 hover:text-gray-900 hover:bg-white rounded-lg text-center"
								href="../dept/list">Department</a>
						</div></li>
				</div>
              ...
              <a href="#" class="flex items-center p-1 text-white hover:text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               <svg class="w-8 h-8 text-gray-100 transition duration-75 dark:text-gray-400 group-hover:text-white hover:text-gray-900 dark:group-hover:text-gray-100" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
				...
				<li><a href="#"
					class="flex items-center p-2 text-white hover:text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
						<svg
							class="w-6 h-6 text-gray-100 transition duration-75 dark:text-gray-400 group-hover:text-white hover:text-gray-900 dark:group-hover:text-white"
							aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24"
							height="24" fill="currentColor" viewBox="0 0 24 24">
                  <path fill-rule="evenodd"
								d="M9.586 2.586A2 2 0 0 1 11 2h2a2 2 0 0 1 2 2v.089l.473.196.063-.063a2.002 2.002 0 0 1 2.828 0l1.414 1.414a2 2 0 0 1 0 2.827l-.063.064.196.473H20a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2h-.089l-.196.473.063.063a2.002 2.002 0 0 1 0 2.828l-1.414 1.414a2 2 0 0 1-2.828 0l-.063-.063-.473.196V20a2 2 0 0 1-2 2h-2a2 2 0 0 1-2-2v-.089l-.473-.196-.063.063a2.002 2.002 0 0 1-2.828 0l-1.414-1.414a2 2 0 0 1 0-2.827l.063-.064L4.089 15H4a2 2 0 0 1-2-2v-2a2 2 0 0 1 2-2h.09l.195-.473-.063-.063a2 2 0 0 1 0-2.828l1.414-1.414a2 2 0 0 1 2.827 0l.064.063L9 4.089V4a2 2 0 0 1 .586-1.414ZM8 12a4 4 0 1 1 8 0 4 4 0 0 1-8 0Z"
								clip-rule="evenodd" />
                </svg> <span class="flex-1 ms-2 whitespace-nowrap">Settings</span>
				</a></li>
				<li>
					<form action="/customLogout" method='post'>
						<input type="hidden" name="${_csrf.parameterName}"
							...
							class="flex items-center p-2 text-white hover:text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
							<svg
								class="flex-shrink-0 text-gray-100 transition duration-75 dark:text-gray-400 group-hover:text-white hover:text-gray-900 dark:group-hover:text-white"
								aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24"
								height="24" fill="none" viewBox="0 0 24 24">
                  <path stroke="currentColor" stroke-linecap="round"
									stroke-linejoin="round" stroke-width="2"
									d="M20 12H8m12 0-4 4m4-4-4-4M9 4H7a3 3 0 0 0-3 3v10a3 3 0 0 0 3 3h2" />
                </svg> <span class="flex-1 ms-2 whitespace-nowrap">Logout</span>
					</form> </a>
				</li>
